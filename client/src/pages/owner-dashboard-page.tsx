...
export function OwnerDashboardPage() {
  ...
  useEffect(() => { if (businessId) void getOperations().then((items) => setOperations(items.filter((item) => item.businessId === businessId))).catch(() => setOperations([])); }, [businessId]);
